# -*- coding: utf-8 -*-
"""
Created on Mon Dec 14 19:55:08 2020
...
class MF_IPS(object):
    def __init__(self,df_train,df_test,expo_prob_train,expo_prob_test):
        """
        Parameters
        ----------
    ...
    def performance_unbiasedNDCG(self,optimal_hp_combination,step=100):
        df_train=renew_set_MF_IPS(self.df_train,self.expo_prob_train)
        df_test=renew_set_MF_IPS(self.df_test,self.expo_prob_test)              
        # Train the USMF model with the optimal hyperparameter combination on the training set
        trainingalgorithm=trainingalgorithm_MF_IPS(optimal_hp_combination)
        ...
        for useri in unique_user_indices_test:
            ...
            for useri_item_interaction in df_useri_interactions_test.itertuples():
                ...
                relevance_actual=getattr(useri_item_interaction,"rating")
    ...
    def performance_unbiasedrecall(self,optimal_hp_combination,k,step=100):
        ...
        for useri in unique_user_indices_test:
            ...
            unbiased_recall_useri=Get_UnbiasedRecall_MF_IPS.get_unbiasedrecall_MF_IPS(df_test,useri,user_feature,item_feature,threshold,k)
