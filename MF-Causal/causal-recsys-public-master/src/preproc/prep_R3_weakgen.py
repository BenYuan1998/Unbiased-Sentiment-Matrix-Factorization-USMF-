...
DATA_DIR = '../../dat/raw/Phones_Accessories_Amazon'
#DATA_DIR = '../../dat/raw/Digital_Music_Amazon'
#DATA_DIR = '../../dat/raw/Food_Restaurants_Yelp'

tr_vd_file_name="df_train_Amazon_digital_music_N20.csv"
test_file_name="df_test_Amazon_digital_music_N20.csv"
# In[4]:
...
tr_vd_data = pd.read_csv(os.path.join(DATA_DIR,tr_vd_file_name))[names]
test_data = pd.read_csv(os.path.join(DATA_DIR,test_file_name))[names]
